...
//                            _isArrive.value = true
    ...
    fun markDeparture() {
        ...
        println(newPassengerOnBoard)
        println(_passengerOnBoard.value!!.toInt())
        println(_passengerDisembarking.value!!.toInt() )
        println(_passengerBoarding.value!!.toInt())
...
//             * 5. create departure document and passenger document in BusOperation
//             */
////            val newPassengerOnBoard =  _passengerOnBoard.value!!.toInt() -
////                    _passengerDisembarking.value!!.toInt() +
////                    _passengerBoarding.value!!.toInt() +
//
//            val newPassengerOnBoard =  Integer.parseInt(_passengerOnBoard.value!!) - Integer.parseInt(_passengerDisembarking.value!!) +  Integer.parseInt(_passengerBoarding.value!!)
//
//            db.runBatch { batch ->
//                // update busArchive
//                if (isLastStop) {
